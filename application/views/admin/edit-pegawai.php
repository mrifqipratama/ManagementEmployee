...
<div class="container-fluid">
    ...
    <div class="card shadow mb-4 ml-2 mr-2">
        <div class="card-body">
            ...
            <div class="col-lg-9">
                <form class="pegawai" method="post" action="<?= base_url('admin/updatePegawai'); ?>" enctype="multipart/form-data">
                    ...
                    <div class="form-group row mb-3">
                        ...
                        <div class="col-sm-9">
                            <input type="text" class="form-control" id="nip" name="nip" placeholder="Masukkan NIP" value="<?= $query->nip; ?>">
                    ...
                    <div class="form-group row mb-3">
                        ...
                        <div class="col-sm-9">
                            <input type="text" class="form-control" id="nik" name="nik" placeholder="Masukkan NIK" value="<?= $query->nik; ?>">
                    ...
                    <div class="form-group row mb-3">
                        ...
                        <div class="col-sm-9">
                            <input type="text" class="form-control" id="nuptk" name="nuptk" placeholder="Masukkan NUPTK" value="<?= $query->nuptk; ?>">
                    ...
                    <div class="form-group row mb-3">
                        ...
                        <div class="col-sm-9">
                            <input type="text" class="form-control" id="nama_pegawai" name="nama_pegawai" placeholder="Masukkan Nama Lengkap Pegawai" value="<?= $query->nama_pegawai; ?>">
                    ...
                    <div class="form-group row mb-3">
                        ...
                        <div class="col-sm-9">
                            <input type="date" class="form-control" id="tgl_lahir" name="tgl_lahir" value="<?= $query->tgl_lahir; ?>">
                        ...
                        <div class="col-sm-9">
                            <div class=" form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="jk" id="jk" value="Laki-Laki" <?php if (isset($_POST['jk']) && $_POST['jk'] == "Laki-Laki") echo "checked";
                                                                                                                    elseif ($query->jk == 'Laki-Laki') echo 'checked'; ?>>
                            ...
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="jk" id="jk" value="Perempuan" <?php if (isset($_POST['jk']) && $_POST['jk'] == "Perempuan")  echo "checked";
                                                                                                                    elseif ($query->jk == 'Perempuan') echo 'checked'; ?>>
                                <label class="form-check-label" for="jk">
                                    Perempuan
                                </label>
                            </div>
                    ...
                    <div class="form-group row mb-3">
                        ...
                        <div class="col-sm-9">
                            <input type="text" class="form-control" id="no_telp" name="no_telp" placeholder="Masukkan Nomor Telp" value="<?= $query->no_telp; ?>">
                    ...
                    <div class="form-group row mb-3">
                        ...
                        <div class="col-sm-9">
                            <select class="form-control" id="pendidikan" name="pendidikan">
                                <option selected><?= $query->pendidikan; ?></option>
                    ...
                    <div class="form-group row mb-3">
                        ...
                        <div class="col-sm-9">
                            <textarea class="form-control" id="alamat" name="alamat" placeholder="Masukkan Alamat" rows="3"><?= $query->alamat; ?></textarea>
                    ...
                    <div class="form-group row mb-3">
                        ...
                        <div class="col-sm-9">
                            <select class="form-control" id="mapel" name="mapel">
                                <option selected><?= $query->mapel; ?></option>
                    ...
                    <div class="form-group row mb-3">
                        ...
                        <div class="col-sm-9">
                            <input type="text" class="form-control" id="masa_kerja" name="masa_kerja" placeholder="Masukkan Masa Kerja" value="<?= $query->masa_kerja; ?>">
                        ...
                        <div class="col-sm-9">
                            <div class=" form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="role_id" id="role_id" value="1" <?php if (isset($_POST['role_id']) && $_POST['role_id'] == "1") echo "checked";
                                                                                                                    elseif ($query->role_id == '1') echo 'checked'; ?>>
                            ...
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="role_id" id="role_id" value="2" <?php if (isset($_POST['role_id']) && $_POST['role_id'] == "2")  echo "checked";
                                                                                                                    elseif ($query->role_id == '2') echo 'checked'; ?>>
                                <label class="form-check-label" for="role_id">
                                    2 (Pegawai)
                                </label>
                            </div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="role_id" id="role_id" value="3" <?php if (isset($_POST['role_id']) && $_POST['role_id'] == "3")  echo "checked";
                                                                                                                    elseif ($query->role_id == '3') echo 'checked'; ?>>
                                <label class="form-check-label" for="role_id">
                                    3 (Kepala Sekolah)
                                </label>
                            </div>
                    ...
                    <div class="form-group row mb-3">
                        ...
                        <div class="col-sm-9">
                            <input type="text" class="form-control" id="total_sehari" name="total_sehari" placeholder="Masukkan Total Sehari" value="<?= $query->total_sehari; ?>">
                        </div>
                    </div>
                    <div class="form-group row mb-3">
                        ...
                        <div class="col-sm-9">
                            <input type="text" class="form-control" id="ekuivalensi" name="ekuivalensi" placeholder="Masukkan Ekuivalensi" value="<?= $query->ekuivalensi; ?>">
                        </div>
                    </div>
                    ...
                    <div class="form-group row mb-3">
                        ...
                        <div class="col-sm-9">
                            <input type="text" class="form-control" id="gaji_pokok" name="gaji_pokok" placeholder="Masukkan Gaji Pokok" value="<?= $query->gaji_pokok; ?>">
                        ...
                        <div class="col-sm-9">
                            <div class=" form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="status_tpg" id="status_tpg" value="Sudah Menerima TPG" <?php if (isset($_POST['status_tpg']) && $_POST['status_tpg'] == "Sudah Menerima TPG") echo "checked";
                                                                                                                                            elseif ($query->status_tpg == 'Sudah Menerima TPG') echo 'checked'; ?>>
                            ...
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="status_tpg" id="status_tpg" value="Belum Menerima TPG" <?php if (isset($_POST['status_tpg']) && $_POST['status_tpg'] == "Belum Menerima TPG") echo "checked";
                                                                                                                                            elseif ($query->status_tpg == 'Belum Menerima TPG') echo 'checked'; ?>>
                                <label class="form-check-label" for="status_tpg">
                                    Belum Menerima TPG
                                </label>
                            </div>
                    ...
                    <div class="form-group row mb-3">
                        ...
                        <div class="col-sm-9">
                            <input type="text" class="form-control" id="tpg_mulai" name="tpg_mulai" placeholder="Masukkan Menerima TPG Mulai" value="<?= $query->tpg_mulai; ?>">
                        </div>
                    </div>
                    <div class="form-group row mb-3">
                        <label for="tpg_perbulan" class="col-sm-3 col-form-label">Besarnya TPG Perbulan</label>
                        <div class="col-sm-9">
                            <input type="text" class="form-control" id="tpg_perbulan" name="tpg_perbulan" placeholder="Masukkan Besarnya TPG Perbulan" value="<?= $query->tpg_perbulan; ?>">
                        </div>
                    </div>
                    <div class="form-group row mb-3">
                        ...
                        <div class="col-sm-9">
                            <div class=" form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="status_tfg" id="status_tfg" value="Sudah Menerima TFG" <?php if (isset($_POST['status_tfg']) && $_POST['status_tfg'] == "Sudah Menerima TFG") echo "checked";
                                                                                                                                            elseif ($query->status_tfg == 'Sudah Menerima TFG') echo 'checked'; ?>>
                            ...
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="status_tfg" id="status_tfg" value="Belum Menerima TFG" <?php if (isset($_POST['status_tfg']) && $_POST['status_tfg'] == "Sudah Menerima TFG") echo "checked";
                                                                                                                                            elseif ($query->status_tfg == 'Belum Menerima TFG') echo 'checked'; ?>>
                                <label class="form-check-label" for="status_tfg">
                                    Belum Menerima TFG
                                </label>
                            </div>
                    ...
                    <div class="form-group row mb-3">
                        ...
                        <div class="col-sm-9">
                            <input type="text" class="form-control" id="tfg_mulai" name="tfg_mulai" placeholder="Masukkan Menerima TFG Mulai" value="<?= $query->tfg_mulai; ?>">
                        </div>
                    </div>
                    <div class="form-group row mb-3">
                        <label for="tfg_perbulan" class="col-sm-3 col-form-label">Besarnya TFG Perbulan</label>
                        <div class="col-sm-9">
                            <input type="text" class="form-control" id="tfg_perbulan" name="tfg_perbulan" placeholder="Masukkan Besarnya TFG Perbulan" value="<?= $query->tfg_perbulan; ?>">
                        </div>
                    </div>
                    <div class="form-group row mb-3">
                        ...
                        <div class="col-sm-9">
                            <input type="date" class="form-control" id="tmt_sk_terakhir" name="tmt_sk_terakhir" placeholder="TMT SK Terakhir" value="<?= $query->tmt_sk_terakhir; ?>">
                        ...
                        <div class="col-sm-9">
                            <div class=" form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="status_kepegawaian" id="status_kepegawaian" value="PNS" <?php if (isset($_POST['status_kepegawaian']) && $_POST['status_kepegawaian'] == "PNS") echo "checked";
                                                                                                                                            elseif ($query->status_kepegawaian == 'PNS') echo 'checked'; ?>>
                            ...
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="status_kepegawaian" id="status_kepegawaian" value="Non - PNS" <?php if (isset($_POST['status_kepegawaian']) && $_POST['status_kepegawaian'] == "Non - PNS") echo "checked";
                                                                                                                                                    elseif ($query->status_kepegawaian == 'Non - PNS') echo 'checked'; ?>>
                                <label class="form-check-label" for="status_kepegawaian">
                                    Non - PNS
                                </label>
                            </div>
                    ...
                    <div class="form-group row mb-3">
                        ...
                        <div class="col-sm-9">
                            <input type="date" class="form-control" id="tmt_inpassing" name="tmt_inpassing" placeholder="TMT Inpassing" value="<?= $query->tmt_inpassing; ?>">
                        </div>
                    </div>
                    <div class="form-group row mb-3">
                        <label for="no_sk_inpassing" class="col-sm-3 col-form-label">No SK Inpassing</label>
                        <div class="col-sm-9">
                            <input type="text" class="form-control" id="no_sk_inpassing" name="no_sk_inpassing" placeholder="Masukkan No SK Inpassing" value="<?= $query->no_sk_inpassing; ?>">
                        </div>
                    </div>
                    <div class="form-group row mb-3">
                        ...
                        <div class="col-sm-9">
                            <select class="form-control" id="golongan" name="golongan">
                                <option selected><?= $query->golongan; ?></option>
                    ...
                    <div class="form-group row mb-3">
                        ...
                        <div class="col-sm-9">
                            <select class="form-control" id="jabatan" name="jabatan">
                                <option selected><?= $query->jabatan; ?></option>
                    ...
                    <div class="form-group row mb-3">
                        ...
                        <div class="col-sm-9">
                            <input type="text" class="form-control" id="nrg" name="nrg" placeholder="Masukkan No Regis Guru" value="<?= $query->nrg; ?>">
                        </div>
                    </div>
                    <div class="form-group row mb-3">
                        <label for="no_sk_nrg" class="col-sm-3 col-form-label">No SK NRG</label>
                        <div class="col-sm-9">
                            <input type="text" class="form-control" id="no_sk_nrg" name="no_sk_nrg" placeholder="Masukkan No SK NRG" value="<?= $query->no_sk_nrg; ?>">
                        </div>
                    </div>
                    <div class="form-group row mb-3">
                        <label for="tgl_sk_nrg" class="col-sm-3 col-form-label">Tanggal SK NRG</label>
                        <div class="col-sm-9">
                            <input type="date" class="form-control" id="tgl_sk_nrg" name="tgl_sk_nrg" placeholder="Tanggal SK NRG" value="<?= $query->tgl_sk_nrg; ?>">
                        </div>
                    </div>
                    <div class="form-group row mb-3">
                        <label for="no_sk_pgtnp" class="col-sm-3 col-form-label">No SK Pengangkatan Guru Tetap Non-PNS</label>
                        <div class="col-sm-9">
                            <input type="text" class="form-control" id="no_sk_pgtnp" name="no_sk_pgtnp" placeholder="Masukkan NO SK PGTNP" value="<?= $query->no_sk_pgtnp; ?>">
                        </div>
                    </div>
                    <div class="form-group row mb-3">
                        <label for="tgl_sk_pgtnp" class="col-sm-3 col-form-label">Tanggal SK PGTNP</label>
                        <div class="col-sm-9">
                            <input type="date" class="form-control" id="tgl_sk_pgtnp" name="tgl_sk_pgtnp" placeholder="Tanggal SK PGTNPr" value="<?= $query->tgl_sk_pgtnp; ?>">
                        </div>
                    </div>
                    <!-- Button  -->
                    <div class=" form-group row mb-3 justify-content-end">
                        <div class="col-sm-10 text-right">
                            <button type="submmit" class="btn btn-info">Update Data Pegawai</button>
                        </div>
                    </div>
